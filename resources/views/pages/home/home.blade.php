...
<link rel="stylesheet" href="{{ asset('themes/AdminLTE-3.1.0/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
<!-- iCheck -->
...
<!-- overlayScrollbars -->
<link rel="stylesheet" href="{{ asset('themes/AdminLTE-3.1.0/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}">
<!-- Daterange picker -->
...
<div class="wrapper">
    ...
    <img class="animation__shake" src="{{ asset('themes/AdminLTE-3.1.0/dist/img/AdminLTELogo.png') }}" alt="AdminLTELogo" height="60" width="60">
    </div>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <!-- Message Start -->
            <div class="media">
                <img src="{{ asset('themes/AdminLTE-3.1.0/dist/img/user1-128x128.jpg') }}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
            ...
            <!-- Message Start -->
            <div class="media">
                <img src="{{ asset('themes/AdminLTE-3.1.0/dist/img/user8-128x128.jpg') }}" alt="User Avatar" class="img-size-50 img-circle mr-3">
                <div class="media-body">
                <h3 class="dropdown-item-title">
                    John Pierce
            ...
            <!-- Message Start -->
            <div class="media">
                <img src="{{ asset('themes/AdminLTE-3.1.0/dist/img/user3-128x128.jpg') }}" alt="User Avatar" class="img-size-50 img-circle mr-3">
                <div class="media-body">
                <h3 class="dropdown-item-title">
                    Nora Silvester
    ...
    <a href="index3.html" class="brand-link">
        <img src="{{ asset('themes/AdminLTE-3.1.0/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
        style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="image">
            <img src="{{ asset('themes/AdminLTE-3.1.0/dist/img/user2-160x160.jpg') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <div class="row">
            ...
            <div class="card direct-chat direct-chat-primary">
                ...
                <div class="direct-chat-messages">
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{ asset('themes/AdminLTE-3.1.0/dist/img/user1-128x128.jpg') }}" alt="message user image">
                    <!-- /.direct-chat-img -->
                    ...
                    <!-- /.direct-chat-infos -->
                    <img class="direct-chat-img" src="{{ asset('themes/AdminLTE-3.1.0/dist/img/user3-128x128.jpg') }}" alt="message user image">
                    <!-- /.direct-chat-img -->
                    <div class="direct-chat-text">
...
<!-- Tempusdominus Bootstrap 4 -->
<script src="{{ asset('themes/AdminLTE-3.1.0/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}"></script>
<!-- Summernote -->
<script src="{{ asset('themes/AdminLTE-3.1.0/plugins/summernote/summernote-bs4.min.js') }}"></script>
<!-- overlayScrollbars -->
<script src="{{ asset('themes/AdminLTE-3.1.0/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js') }}"></script>
<!-- AdminLTE App -->
